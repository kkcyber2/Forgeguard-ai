  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Semantic aliases — driven by CSS variables in globals.css
        background: "var(--fg-background)",
        surface: "var(--fg-surface)",
        "surface-raised": "var(--fg-surface-raised)",
        border: "var(--fg-border)",
        "border-strong": "var(--fg-border-strong)",
        foreground: "var(--fg-foreground)",
        "foreground-muted": "var(--fg-foreground-muted)",
        "foreground-subtle": "var(--fg-foreground-subtle)",
      },
      fontFamily: {
