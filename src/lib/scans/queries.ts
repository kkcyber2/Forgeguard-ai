...
/** Sum ALE ($) from sealed scans only — scan_reports.financial_liability_usd. */
...
export const SCAN_REPORT_SELECT =
  "executive_summary_md, executive_summary, audit_report_md, cvss_overall, risk_label, findings, attack_path, optimization_suggestions_md, owasp_coverage, generation_cost_usd, discovery_report, ale_usd, financial_liability_usd, technical_proof_of_concept, remediation_code_snippet, aegis_zip_b64, attacks_run";
